...
/// See [`ExifIterEntry::tag`](crate::ExifIterEntry::tag) (returns [`TagOrCode`]
/// which exposes `.code()`) and [`Exif::get_by_code`](crate::Exif::get_by_code).
#[allow(unused)]
#[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
...
pub enum ExifTag {
    ...
    CameraSerialNumber = 0x0000_a431,
...
impl ExifTag {
    ...
    pub fn from_code(code: u16) -> Option<Self> {
        ...
        let tag = match code {
            ...
            x if x == CameraSerialNumber.code() => Self::CameraSerialNumber,
            ...
            x if x == LensSerialNumber.code() => Self::LensSerialNumber,
